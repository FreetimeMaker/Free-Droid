...
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_APP_LIST_SORT_ORDER
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_AUTO_UPDATES
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_DYNAMIC_COLORS
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_LAST_UPDATE_CHECK
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_PROXY
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_REPO_UPDATES
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_SHOW_INCOMPATIBLE
import com.freetime.freedroid.settings.SettingsConstants.PREF_DEFAULT_THEME
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_APP_LIST_SORT_ORDER
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_AUTO_UPDATES
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_DYNAMIC_COLORS
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_IGNORED_APP_ISSUES
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_LAST_UPDATE_CHECK
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_PROXY
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_REPO_UPDATES
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_SHOW_INCOMPATIBLE
import com.freetime.freedroid.settings.SettingsConstants.PREF_KEY_THEME
import com.freetime.freedroid.settings.SettingsConstants.getAppListSortOrder
import com.freetime.freedroid.settings.SettingsConstants.toSettings
